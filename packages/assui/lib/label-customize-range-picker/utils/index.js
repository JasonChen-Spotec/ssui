...
exports.getTimeDiffOfShowTime =
  exports.getDateDiffScope =
  exports.formatMaxScope =
  exports.ONE_MINUTE_MILLISECOND =
  exports.ONE_DAY_MILLISECOND =
    void 0;
...
var formatMaxScope = function formatMaxScope(dateStampTuple, maxScope) {
  ...
  var startStamp =
    (_a = start === null || start === void 0 ? void 0 : start.clone().startOf('day')) !==
      null && _a !== void 0
      ? _a
      : null;
  var endStamp =
    (_b = end === null || end === void 0 ? void 0 : end.clone().endOf('day')) !== null &&
    _b !== void 0
      ? _b
      : null;
  ...
  if (startStamp || endStamp) {
    startStamp =
      startStamp !== null && startStamp !== void 0
        ? startStamp
        : endStamp
            .clone()
            .subtract(maxScope - 1, 'day')
