...
var LabelCustomizeRangePicker = function LabelCustomizeRangePicker(props) {
  ...
  var defaultRadioList = customizeTimeList
    ? (0, defaultRadioList_1['default'])(defaultRadioListParams).filter(function (item) {
  ...
  var onDateChange = function onDateChange(nextValue) {
    ...
    if (nextStartDate && nextEndDate) {
      ...
      nextStartDate = showTime
        ? nextEndDate
            .clone()
            .subtract((0, utils_1.getTimeDiffOfShowTime)(scope), 'milliseconds')
            .startOf('minute')
        : nextEndDate
            .clone()
      ...
      nextEndDate = showTime
        ? nextStartDate
            .clone()
            .add((0, utils_1.getTimeDiffOfShowTime)(scope), 'milliseconds')
            .endOf('minute')
        : nextStartDate
            .clone()
            .add(scope - 1, 'day')
      ...
      react_1['default'].createElement(
        ...
        react_1['default'].createElement(
          ...
          react_1['default'].createElement(
            ...
            (0, messages_1['default'])(
              messages,
              messages_1.langTypeEnum.labelCustomizeRangePicker,
              'customTime',
            ),
          ),
        ),
  ...
  return rangePickerType === 'label'
    ? react_1['default'].createElement(
        label_range_picker_1['default'],
        __assign(
          {
            showTime: showTime,
            label: label,
          },
          (0, omit_1['default'])(restProps, 'onChange', 'value', 'open'),
          baseOptions,
        ),
      )
    : react_1['default'].createElement(
        ...
        __assign(
          ...
          baseOptions,
          (0, omit_1['default'])(restProps, 'onChange'),
        ),
      );
};
