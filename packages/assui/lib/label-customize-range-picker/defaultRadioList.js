...
var getDefaultRadioList = function getDefaultRadioList(_a) {
  ...
  var now = (0, lodash_1.isNumber)(timeOffset)
    ? dateUtils_1['default'].getToday(timeOffset)
    : dateUtils_1['default'].getToday();
  var allRadio = displayAllOption
    ? [
        {
          key: dateTypeEnum.ALL,
          text: (0, messages_1['default'])(
            messages,
            messages_1.langTypeEnum.labelCustomizeRangePicker,
            'all',
          ),
          value: [
            startTimeOfAllOption || dateUtils_1['default'].parseDate('2022/09/01'),
            now.endOf('day'),
          ],
        },
      ]
