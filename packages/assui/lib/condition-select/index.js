...
var ConditionSelect = function ConditionSelect(_a) {
  ...
  var _b = __read((0, useControllableValue_1["default"])({
      value: value,
      onChange: onChange
    }), 2),
    componentValue = _b[0],
  ...
  }))), DynamicComponent && react_1["default"].createElement(col_1["default"], {
    span: 14
  }, react_1["default"].createElement(DynamicComponent, __assign(__assign({}, componentProps), {
