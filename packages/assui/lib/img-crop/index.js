    ...
    canvas.toBlob(_async(function (blob) {
      ...
      return _invoke(function () {
        if (zipImg) {
          ...
          return _await((0, getCroppedImg_1["default"])(imgUrl, zipImg, name, type), function (_ref) {
  ...
  var renderComponent = function renderComponent(titleOfModal) {
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, {
      children: [renderUpload(), src && (0, jsx_runtime_1.jsxs)(modal_1["default"], _extends({
        ...
        }, cropperProps)), hasZoom && (0, jsx_runtime_1.jsxs)("div", {
        ...
        }), hasRotate && (0, jsx_runtime_1.jsxs)("div", {
