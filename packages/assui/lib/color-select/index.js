...
var ColorSelect = function ColorSelect(props) {
  ...
  var defaultValueNode = react_1['default'].createElement(
    'div',
    {
    ...
    value
      ...
      : react_1['default'].createElement(
          ...
          (0, messages_1['default'])(
            messages,
            messages_1.langTypeEnum.global,
            'placeholder',
          ),
        ),
    react_1['default'].createElement(
  ...
  return react_1['default'].createElement(
    ...
    react_1['default'].createElement(
      ...
      __assign(
        ...
        RcTriggerProps,
        {
          popup: react_1['default'].createElement(
            react_color_1.SketchPicker,
            __assign(
              {
                width: '320px',
