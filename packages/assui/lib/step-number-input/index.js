...
var DisabledContext_1 = __importDefault(
  require('antd/lib/config-provider/DisabledContext'),
);
...
var StepNumberInput = function StepNumberInput(props) {
  ...
  var maxCondition = (0, isUndefined_1['default'])(max)
    ? false
    : max === Number(value) || Number(max) < Number(plusNumber);
  var minCondition = (0, isUndefined_1['default'])(min)
    ? false
