...
var findAllSubSelectItems = function findAllSubSelectItems(dataSource, key) {
  var _a, _b;
  return (_b =
    (_a = dataSource.find(function (item) {
      return item.value === key;
    })) === null || _a === void 0
      ? void 0
      : _a.children) === null || _b === void 0
    ? void 0
    : _b.map(function (subItem) {
...
var ConditionSelectInput = function ConditionSelectInput(props) {
  ...
  /** 子选择器是否多选 */
  var isSubSelectMultiple =
    (conditionSelectProps === null || conditionSelectProps === void 0
      ? void 0
      : conditionSelectProps.mode) === 'multiple';
  (0, react_1.useEffect)(
    function () {
  ...
  var onSelectChange = function onSelectChange(selectValue) {
    ...
    if (isSubSelectMultiple) {
      finalSelectInputValue = __assign(__assign({}, finalSelectInputValue), {
        finalSelectValue: !(0, isNil_1['default'])(selectValue)
  ...
  var onTypeSelectChange = function onTypeSelectChange(inputValue) {
    var finalSelectInputValue = {
      selectValue:
        selectInputValue === null || selectInputValue === void 0
          ? void 0
    ...
    if (isSubSelectMultiple) {
      finalSelectInputValue = __assign(__assign({}, finalSelectInputValue), {
        finalSelectValue: (0, isEmpty_1['default'])(inputValue)
          ? findAllSubSelectItems(
              optionsList,
              selectInputValue === null || selectInputValue === void 0
                ? void 0
                : selectInputValue.selectValue,
  ...
  var onConditionSelectInputBlur = function onConditionSelectInputBlur(blurEntryType) {
    onBlur === null || onBlur === void 0
      ? void 0
      : onBlur(
          __assign(__assign({}, selectInputValue), {
  ...
  var isShowInput =
    ...
    !(hiddenInputKeys === null || hiddenInputKeys === void 0
      ? void 0
      : hiddenInputKeys.includes(selectInputValue.selectValue));
  var typeInput = isInput
    ? react_1['default'].createElement(
        ...
        react_1['default'].createElement(
          condition_input_1['default'],
          __assign({}, conditionInputProps, {
    ...
    : react_1['default'].createElement(
        ...
        react_1['default'].createElement(
          complex_val_select_1['default'],
          __assign({}, conditionSelectProps, {
