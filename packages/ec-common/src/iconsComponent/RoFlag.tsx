...
const SvgRoFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg width={26} height={18} fill="none" xmlns="http://www.w3.org/2000/svg" role="img" {...props}>
    ...
    <g mask="url(#ROFlag_svg__a)">
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M0 18h8.418V0H0v18Z" fill="#083780" />
      <path fillRule="evenodd" clipRule="evenodd" d="M8.418 18h8.418V0H8.418v18Z" fill="#FFD147" />
    </g>
  </svg>
);
