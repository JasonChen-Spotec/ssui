...
var useGenderType = function useGenderType() {
  ...
  var appellativeGenderTypeMap =
    ((_a = {}),
    (_a[MALE] = formatMessage(messages_1['default'].male)),
    (_a[FEMALE] = formatMessage(messages_1['default'].female)),
    (_a[EMPTY] = ''),
    _a);
  var genderTypeMap =
    ((_b = {}),
    (_b[MALE] = formatMessage(messages_1['default'].male)),
    (_b[FEMALE] = formatMessage(messages_1['default'].female)),
    (_b[EMPTY] = '-'),
    _b);
  var genderTypeList = [
    {
