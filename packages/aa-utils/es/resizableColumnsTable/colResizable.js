...
var ColResizable = /** @class */ (function () {
  ...
  ColResizable.prototype.syncGrips = function () {
    ...
    domElmIconList.forEach(function (el) {
      ...
      el.style.marginTop = ''.concat(tryParseInt(marginTopNumber), 'px');
    });
  };
