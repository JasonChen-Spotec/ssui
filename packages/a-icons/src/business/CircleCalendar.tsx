...
function CircleCalendar(componentProps: IconProps) {
  const IconNode = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      id="circle-calendar_svg__\u56FE\u5C42_1"
    ...
    >
      <style>
        {'.circle-calendar_svg__st4{fill:#285a83}.circle-calendar_svg__st5{fill:#ef6f53}'}
      </style>
      <defs>
        <path id="circle-calendar_svg__SVGID_1_" d="M-931.6-750.8h1920v1578h-1920z" />
      </defs>
      <clipPath id="circle-calendar_svg__SVGID_2_">
        <use xlinkHref="#circle-calendar_svg__SVGID_1_" overflow="visible" />
      </clipPath>
      <defs>
        <path id="circle-calendar_svg__SVGID_3_" d="M-933.5-739.7h1920v1578h-1920z" />
      </defs>
      <clipPath id="circle-calendar_svg__SVGID_4_">
        <use xlinkHref="#circle-calendar_svg__SVGID_3_" overflow="visible" />
      </clipPath>
      <g>
        <path
          className="circle-calendar_svg__st4"
      ...
      <g>
        ...
        />
        <path
          className="circle-calendar_svg__st5"
