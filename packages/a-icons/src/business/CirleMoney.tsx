...
function CirleMoney(componentProps: IconProps) {
  const IconNode = (props: React.SVGProps<SVGSVGElement>) => (
    <svg
      ...
      {...props}
    >
      <style>{'.cirle-money_svg__st4{fill:#285a83}.cirle-money_svg__st5{fill:#ef6f53}'}</style>
      <defs>
        <path id="cirle-money_svg__SVGID_1_" d="M-931.6-750.8h1920v1578h-1920z" />
      </defs>
      <clipPath id="cirle-money_svg__SVGID_2_">
        <use xlinkHref="#cirle-money_svg__SVGID_1_" overflow="visible" />
      </clipPath>
      <defs>
        <path id="cirle-money_svg__SVGID_3_" d="M-933.5-739.7h1920v1578h-1920z" />
      </defs>
