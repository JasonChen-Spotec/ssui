...
function UserInfoAuth(componentProps: IconProps) {
  const IconNode = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        ...
        fill="#DC4946"
      />
      <path d="M13.236 16.332l.504-.108.646 3.024-.504.108-.646-3.024z" fill="#fff" />
      <path d="M14.435 16.352l.433.28-1.681 2.596-.433-.28 1.681-2.596z" fill="#fff" />
      <path
        d="M12.653 16.733l-.28.433 2.596 1.681.28-.433-2.596-1.681zM17.36 15.301l.504-.108.646 3.025-.504.107-.646-3.024z"
        fill="#fff"
      />
      <path d="M18.56 15.321l.432.28-1.681 2.596-.433-.28 1.682-2.596z" fill="#fff" />
      <path d="M16.777 15.702l-.28.433 2.596 1.681.28-.432-2.596-1.682z" fill="#fff" />
    </svg>
  );
