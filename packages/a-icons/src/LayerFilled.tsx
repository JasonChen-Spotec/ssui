...
function LayerFilled(componentProps: IconProps) {
  const IconNode = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      />
      <path
        d="M21.29 15.08l-8.85 3.69a2 2 0 01-1.71 0l-7.84-3.68a.754.754 0 10-.63 1.37l7.82 3.62a3.57 3.57 0 001.56.37 3.4 3.4 0 001.4-.31l8.82-3.67a.75.75 0 10-.57-1.39z"
        fill="currentColor"
      />
    </svg>
  );
